...
class Notifier:
    ...
    def check_and_alert(self, reading: dict, co2_high_streak: int) -> None:
        ...
        elif pm25 > config.PM25_WARN and self._can_send("pm25_elevated"):
            self._send(
                "PM2.5 Elevated",
    ...
    def send_daily_summary(self, summary: dict) -> None:
        ...
        message = (
            ...
            f"PM2.5 avg: {pm25_avg:.1f} µg/m³ | Temp avg: {temp_avg:.1f}°C"
        )
